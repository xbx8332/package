 ...
 * 
 */
require_once APP_ROOT_PATH.'Admin/common.php';
require_once APP_ROOT_PATH.'Admin/lib.php';
$wap_config = require_once APP_ROOT_PATH."/Admin/config.php";
$lang = require_once APP_ROOT_PATH."/Admin/lang/zh-cn/common.php";

$IMG_APP_ROOT = APP_ROOT;
define("APP_INDEX","admin_index");
...
$GLOBALS['tmpl']->template_dir   = APP_ROOT_PATH .'Admin/Tpl/public'. TMPL_NAME;

//定义模板路径
$tmpl_path = SITE_DOMAIN.APP_ROOT."/"."Admin/Tpl/public";

$GLOBALS['tmpl']->assign("TMPL",$tmpl_path.TMPL_NAME);
$GLOBALS['tmpl']->assign("TMPL_REAL",APP_ROOT_PATH."Admin/Tpl/".TMPL_NAME); 
$GLOBALS['tmpl']->assign("APP_INDEX",APP_INDEX);

$GLOBALS['tmpl']->assign("APP_ROOT",APP_ROOT);

$page_type_arr = array("admin");
global $page_type;
if(empty($page_type)){
