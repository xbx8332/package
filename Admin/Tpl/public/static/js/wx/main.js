layui.config({
	base : "/Admin/Tpl/public/static/js/wx/"
	...
	if(window.sessionStorage.getItem("systemParameter")){
		...
		$.ajax({
			url : "../../json/wx/systemParameter.json",
			type : "get",
			dataType : "json",
