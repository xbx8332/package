     ...
     <div class="container top">
    	<div class="row">
                        ...
                        <div class="container-fluid">
                        	<div class="row">
                        		<div class="col-lg-4 rs_top">
                        			...
                        			<p><h1 style="text-align:center;font-weight:bold;font-size:30px">5.76%</h2></p>
                        		</div>
                        		<div class="col-lg-4 rs_top">
                        		<h6 style="text-align:center;color:gray;font-size:15px">最低起购金额</h6>
                        			<p><h1 style="text-align:center;font-weight:bold;font-size:30px">10000.00</h2></p>
                        		</div>
                        		<div class="col-lg-4 rs_top">
	    	...
	    	<?php elseif (1 == 1): ?>
	    		<div class="ibox float-e-margins" >
                    <div class="ibox-title">
                        <h3><?php echo $this->_var['licai']['name']; ?> <span style="float:right;font-size:12px;color:rgba(140,140,140,1);">截止日期：<?php echo $this->_var['licai']['end_buy_date']; ?></span></h3>
                        <div class="ibox-tools">
                           <!--  <a class="collapse-link">
                                <i class="fa "><h5>截止日期 </h5></i>
                            </a> -->
                        	...
                        	<div class="row">
                        		<form action="">
	                        		<div class="col-lg-12">
										...
										<h6 style="color:red;font-size:13px;height:10px;margin-top:10px"><!-- *余额不足请充值 --></h6>
	                        		</div>
	                        		<div class="col-lg-12">
	                        			...
	                        			<button type="button" id="purchase" style="background-color:#EEB92C;border-color:#EEB92C;color:white" class="btn  btn-lg btn-block">立即购买</button>
	                        		</div>
                        		</form>
                        	</div>
                        </div>
...
<!--echart图表  -->
 <script>
			...
			<?php $_from = $this->_var['bar']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('k', 'v');if (count($_from)):
    foreach ($_from AS $this->_var['k'] => $this->_var['v']):
?>
				mData1.push("<?php echo $this->_var['k']; ?>");
				<?php if ($this->_var['v'] == 0): ?>
				sData1.push(0);
				<?php else: ?>
				sData1.push("<?php echo $this->_var['v']; ?>");
				<?php endif; ?>
...
?>
			...
			/*  var mData2 = ['1-10','1-11','1-12','1-13','1-14','1-15','1-65'];
			var sData2 = [10,20,25,40,35,60,70];  */
			var mData2 =[];
			var sData2 =[];
			
			<?php $_from = $this->_var['cumulative']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('k', 'v');if (count($_from)):
    foreach ($_from AS $this->_var['k'] => $this->_var['v']):
?>
				mData2.push("<?php echo $this->_var['k']; ?>");
				<?php if ($this->_var['v'] == 0): ?>
				sData2.push(0);
				<?php else: ?>
				sData2.push("<?php echo $this->_var['v']; ?>");
				<?php endif; ?>
			<?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
			console.log(sData1);
