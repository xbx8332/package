...
echo parse_url_tag("u:index|redeem#index|"."id=".$this->_var['data']['id']."".""); 
?>">赎回</a>
							</td>
						</tr>
...
?>
							<tr>
								...
								<td class="text-navy text-center">
									<a href="#" style="display:inline-block;color:rgb(238,185,44);margin-right:10px;" class="">详情</a>
									<a <?php if ($this->_var['data']['status'] == 1): ?>onclick="shuhui(<?php echo $this->_var['data']['id']; ?>)"<?php endif; ?><?php if ($this->_var['data']['status'] == 3): ?>href ="javascript:volid(0);"<?php endif; ?> style="display:inline-block;color:#ededed;" class=""><?php if ($this->_var['data']['status'] == 1): ?>赎回<?php elseif ($this->_var['data']['status'] == 2): ?>部分赎回<?php elseif ($this->_var['data']['status'] == 3): ?>已赎回<?php endif; ?></a>
                            ...
                            <!-- <tr>
                                ...
                                <td class="text-navy text-center"> <a href="#" style="display:inline-block;color:rgb(238,185,44);margin-right:10px;" class="">详情</a><a href="#" style="display:inline-block;color:#ededed;" class="">赎回</a></td>
                            </tr>
                            <tr>
                                <td class="text-center">新手专享-3月</td>
                                <td class="text-center">1000.00</td>
