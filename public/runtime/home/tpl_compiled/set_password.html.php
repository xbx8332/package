	...
	<body class="no-skin" style="background:transparent !important;">
		<!-- <div class="container">
				...
				<div class="row"> -->
					...
					<form action="/index.php?ctl=usercenter&act=validpwd" method="post" onsubmit="return false;" accept-charset="utf-8"  class="form-horizontal user-common-form" id ="valid-form">
						<div class="form-group">
			                <label class="col-xs-4 control-label"><!-- 姓名 --></label>
			                <div class="col-xs-4 errorWrapper">
			                	<p><span class="fs active" >验证密码</span>&nbsp;&nbsp;&nbsp;&nbsp;▶&nbsp;&nbsp;&nbsp;&nbsp;<span class="fs <?php if ($this->_var['step'] == 2): ?>active<?php endif; ?>">设置密码</span></p>	
			                </div>
			                <label class="col-xs-4 control-label"><!-- 姓名 --></label>
			            </div>
			            ...
			            <div class="form-group">
			                ...
			                <div class="col-xs-4 errorWrapper">
			                    ...
			                    <input type="password" name="paypassword" class="form-control valid" placeholder="输入支付密码">
			                </div>
			                <label class="col-xs-4 control-label"></label>
			            </div>
			            <div class="form-group">
			                <label class="col-xs-4 control-label"></label>
			                <div class="col-xs-4 errorWrapper">
			                    <input type="password" name="newpaypassword" class="form-control valid" placeholder="确认支付密码">
			                </div>
			                <label class="col-xs-4 control-label"></label>
			            </div>
