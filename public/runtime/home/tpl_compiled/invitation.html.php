...
table thead tr{
	...
	<body class="no-skin" style="background:transparent !important;">
		<!-- <div class="container">
				...
				<div class="row"> -->
					<!-- <p class="p-class">
						<span class="like-btn">已邀请好友</span>
					</p>
					<table class="table">
						...
						<?php $_from = $this->_var['list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'user');if (count($_from)):
    foreach ($_from AS $this->_var['user']):
?>
						<tr>
							<td><?php echo $this->_var['user']['user_name']; ?></td>
							<td><?php echo $this->_var['user']['create_time']; ?></td>
							<td><?php if ($this->_var['user']['money']): ?>￥<?php echo $this->_var['user']['money']; ?><?php endif; ?></td>
						</tr>
                    ...
                    <div class="ibox-content">
                        ...
                        <table class="table table-striped">
                            <thead>
                            <tr>
                                <th class="text-center">受邀好友</th>
                                <th class="text-center">邀请时间</th>
                                <th class="text-center">邀请收益/元</th>
...
?>
							<tr>
								<td class="text-center"><?php echo $this->_var['user']['user_name']; ?></td>
								<td class="text-center"><?php echo $this->_var['user']['create_time']; ?></td>
								<td class="text-center"><?php if ($this->_var['user']['money']): ?>￥<?php echo $this->_var['user']['money']; ?><?php endif; ?></td>
							</tr>
							<?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
                            <!-- <tr>
                                <td class="text-center">新手专享</td>
