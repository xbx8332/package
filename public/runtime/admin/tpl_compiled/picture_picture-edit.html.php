	...
	<form class="form form-horizontal" id="form-picture-edit">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-3 col-sm-3">
				 <input type="hidden"  id="name" name="name" placeholder="" value="<?php if ($this->_var['data']['name']): ?><?php echo $this->_var['data']['name']; ?><?php endif; ?>" class="input-text"  > 
				<?php if ($this->_var['data']['name']): ?><label><?php echo $this->_var['data']['name']; ?> </label><?php endif; ?>
			</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-5 col-sm-7">
				<input type="hidden" id="imgflag" name="imgflag" value="<?php if ($this->_var['data']['value']): ?>1<?php else: ?>0<?php endif; ?>" >
				<img id="portrait" src="<?php if ($this->_var['data']['value']): ?><?php echo $this->_var['data']['value']; ?><?php endif; ?>"    width="150" height="100"> 
			</div>
		</div>
		<!-- <div class="row cl">
		...
		<div class="row cl">
			<div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-2">
				<input type="hidden" id="id" name="id" value="<?php if ($this->_var['data']['id']): ?><?php echo $this->_var['data']['id']; ?><?php endif; ?>" >
	...
	$("#form-picture-edit").validate({
		...
		submitHandler:function(form){
			...
			$(form).ajaxSubmit({
				...
				dataType:'json',
				url:"<?php
echo parse_url_tag("u:admin|system#picture_update|"."".""); 
?>",
				data:$(form).serialize(),
