	...
	<form action="" method="post" class="form form-horizontal" id="form-article-add">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-2 col-sm-2"> 
				<span class="select-box">
				<select class="select">
					<option value="0">余额宝</option>
					<option value="1">银联</option>
					<option value="2">花呗</option>
		...
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">购买手续费率：</label>
		...
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">平台收益率：</label>
			<div class="formControls col-xs-2 col-sm-4">
				<input type="text" class="input-text" value="" placeholder="" id="" name="">
			</div>
			<div class="formControls col-xs-6 col-sm-6">
		...
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">赎回手续费率：</label>
			<div class="formControls col-xs-2 col-sm-4">
				<input type="text" class="input-text" value="" placeholder="" id="" name="">
			</div>
			<div class="formControls col-xs-6 col-sm-6">
		...
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">成交服务率：</label>
			<div class="formControls col-xs-2 col-sm-4">
				<input type="text" class="input-text" value="" placeholder="" id="" name="">
			</div>
			<div class="formControls col-xs-6 col-sm-6">
		...
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">利率范围(文字描述)：</label>
			<div class="formControls col-xs-2 col-sm-4">
				<input type="text" class="input-text" value="" placeholder="" id="" name="">
			</div>
			<div class="formControls col-xs-6 col-sm-6">
