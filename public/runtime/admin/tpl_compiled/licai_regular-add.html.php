...
<script>
	var url = '<?php
echo parse_url_tag("u:admin|licai#current_insert|"."".""); 
?>';
...
<div class="page-container">
	<form action="" method="post" onsubmit="return false;" class="form form-horizontal" id="form-article-add" autocomplete="off">
		<div class="row cl">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-1 col-sm-3">
				<input type="text" class="input-text" value="" placeholder="" id="licai_sn" name="licai_sn">
			</div>
			<div class="formControls col-xs-7 col-sm-7">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-7 col-sm-7">
				<input type="hidden" name="type" value="1">固定理财
			</div>
			<div class="formControls col-xs-8 col-sm-8"></div>
		</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-1 col-sm-3">
				<input name = "begin_buy_date" type="date" />
			</div>
			<div class="formControls col-xs-7 col-sm-7">
		...
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">结束购买时间：</label>
			
			<div class="formControls col-xs-1 col-sm-3">
				<input name = "end_buy_date" type="date" />
			</div>
			<div class="formControls col-xs-7 col-sm-7">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-1 col-sm-3">
				<input type="text" class="input-text" value="" placeholder="" id="min_money" name="min_money">
			</div>
			<div class="formControls col-xs-7 col-sm-7">
		...
		<div class="row cl">
		 ...
		 <div class="row cl">
			<label class="form-label col-xs-4 col-sm-2" ><span class="c-red">*</span>理财期数：</label>
			<div class="formControls col-xs-1 col-sm-3">
				<input type="text" class="input-text" value="" placeholder="" id="site_buy_fee_rate" name="time_limit">
			</div>
			<div class="formControls col-xs-7 col-sm-7">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-2 col-sm-2"> 
				...
				<select class="select" id="begin_interest_type" name="begin_interest_type">
					<option value="0">当天生效</option>
					<option value="1">次日生效</option>
					<option value="2">下个工作日生效</option>
					<option value="3">下两个工作日生效</option>
				</select>
				</span> 
			</div>
			<div class="formControls col-xs-8 col-sm-8"></div>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-1 col-sm-3">
				<input type="text" class="input-text" value="" placeholder="" id="product_size" name="product_size">
			</div>
			<div class="formControls col-xs-7 col-sm-7">
		...
		<div class="row cl">
		 ...
		 <div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<textarea id="purchasing_time" name="purchasing_time" cols="" rows="" class="textarea"  placeholder="说点什么...最少输入10个字符" datatype="*10-100" dragonfly="true" nullmsg="备注不能为空！" onKeyUp="$.Huitextarealength(this,200)"></textarea>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<!-- <textarea id="rule_info" name="rule_info" cols="" rows="" class="textarea"  placeholder="说点什么...最少输入10个字符" datatype="*10-100" dragonfly="true" nullmsg="备注不能为空！" onKeyUp="$.Huitextarealength(this,200)"></textarea> -->
		...
		<!-- <div class="row cl">
					...
					<div class="formControls col-xs-3 col-sm-3">
						...
						<p style="color:orange">图片上传尺寸：483*762</p>
					</div>
