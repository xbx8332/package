			...
			<table class="table table-border table-bordered table-bg table-hover table-sort">
				<thead>
					<tr class="text-c">
						...
						<th width="100" style="color: red">赎回总金额</th>
						<th width="60">申请时间</th>
						<th width="60">状态</th>
						<!-- <th width="100">操作</th> -->
					</tr>
...
?>
				<tbody>
					<tr class="text-c va-m">
						...
						<td><?php echo $this->_var['list']['type_format']; ?></td>
						<td class="text-l"><?php echo $this->_var['list']['user_name']; ?></td>
						<td class="text-l"><?php echo $this->_var['list']['money']; ?></td>
						<td><?php echo $this->_var['list']['show_rate_format']; ?></td>
						<td><?php echo $this->_var['list']['earn_money_format']; ?></td>
						<td style="color: red"><?php echo $this->_var['list']['redempte_money']; ?></td>
						<td><?php echo $this->_var['list']['create_date']; ?></td>
						<td class="td-status"><span class="label label-success radius"><?php echo $this->_var['list']['status_format']; ?></span></td>
						<!-- <td class="td-manage">
						<?php if ($this->_var['list']['status'] == 0): ?>
						<a style="text-decoration:none" class="ml-5" onClick="over_stop(this,<?php echo $this->_var['list']['id']; ?>)" href="javascript:;" title="停用"><i class="Hui-iconfont">&#xe6a6;</i></a> 
						<span style="text-decoration:none" class="ml-5">|</span>
						<a style="text-decoration:none" class="ml-5" onClick="over_suess(this,<?php echo $this->_var['list']['id']; ?>)" href="javascript:;" title="启用"><i class="Hui-iconfont">&#xe6a7;</i></a>
						<?php endif; ?>
						</td> -->
