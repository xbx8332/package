...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 图片管理 <span class="c-gray en">&gt;</span> 图片列表 <a class="btn btn-success btn-refresh radius r" style="line-height:1.6em;margin-top:3px" href="javascript:void(0)" onclick="refresh()" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
<div class="page-container">
	<div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l"><!-- <a href="javascript:;" onclick="datadel()" class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i> 批量删除</a> --> <a class="btn btn-primary radius" onclick="picture_add('添加图片','<?php
echo parse_url_tag("u:admin|system#picture_add|"."".""); 
?>')" href="javascript:;"><i class="Hui-iconfont">&#xe600;</i> 添加图片</a></span> <span class="r">共有数据：<strong>54</strong> 条</span> </div>
	<div class="mt-20">
...
?>
				<tr class="text-c">
					...
					<td><!-- <a href="javascript:void(0);" onClick="picture_edit('图库编辑','picture-show.html','10001')"> --><img width="210" height="100" class="picture-thumb" src="<?php echo $this->_var['item']['value']; ?>"><!-- </a> --></td>
					...
					<td class="td-manage"> <a style="text-decoration:none" class="ml-5" onClick="picture_edit('图片编辑','<?php
echo parse_url_tag("u:admin|system#picture_edit|"."".""); 
?>','<?php echo $this->_var['item']['id']; ?>')" href="javascript:;" title="编辑"><i class="Hui-iconfont">&#xe6df;</i></a> <a style="text-decoration:none" class="ml-5" onClick="picture_del(this,'<?php echo $this->_var['item']['id']; ?>')" href="javascript:;" title="删除"><i class="Hui-iconfont">&#xe6e2;</i></a></td>
				</tr>
...
function picture_del(obj,id){
	layer.confirm('确认要删除吗？',function(index){
		$.ajax({
			...
			data:{id:id},
			url: "<?php
echo parse_url_tag("u:admin|system#picture_del|"."".""); 
?>",
			dataType: 'json',
