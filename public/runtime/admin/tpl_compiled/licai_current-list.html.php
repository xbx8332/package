...
<body >
	<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 产品管理 <span class="c-gray en">&gt;</span> 活期宝 <a class="btn btn-success btn-refresh radius r" style="line-height:1.6em;margin-top:3px" onclick="refresh();" href="javascript:void(0);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
...
echo parse_url_tag("u:admin|licai#current_add|"."".""); 
...
?>
				<tbody>
					<tr class="text-c va-m">
						...
						<td class="text-l"><a style="text-decoration:none" onClick="current_float_check('浮动查看','<?php
echo parse_url_tag("u:admin|licai#float_check|"."".""); 
?>','<?php echo $this->_var['list']['id']; ?>','','510')" href="javascript:;" title="浮动查看">浮动查看</a></td>
						...
						<td class="td-manage"><a style="text-decoration:none" onClick="set_rate('设置利率','<?php
echo parse_url_tag("u:admin|licai#set_rate|"."".""); 
...
echo parse_url_tag("u:admin|licai#current_edit|"."".""); 
