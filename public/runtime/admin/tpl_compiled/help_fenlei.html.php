...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 分类分类 <span class="c-gray en">&gt;</span> 分类列表 <a class="btn btn-success radius r btn-refresh" style="line-height:1.6em;margin-top:3px" href="javascript:void(0);" onclick="refresh();" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
<div class="page-container">
	
	<div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l"><a href="javascript:;" onclick="deldata()" class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i> 批量删除</a> <a href="javascript:;" onclick="admin_add('添加分类','<?php
echo parse_url_tag("u:admin|help#fenlei_add|"."".""); 
?>','800','500')" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 添加分类</a></span> </div>
...
?>
			<tr class="text-c">
				...
				<td class="td-manage">
				<a title="编辑" href="javascript:;" class="ml-5"  onclick="fenlei_edit('编辑','<?php
echo parse_url_tag("u:admin|help#fenlei_edit|"."".""); 
?>','<?php echo $this->_var['list']['id']; ?>','','510')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a> 
				<a title="删除" href="javascript:;" onclick="fenlei_del(this,<?php echo $this->_var['list']['id']; ?>)" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6e2;</i></a></td>
			</tr>
...
function deldata(){
	...
	layer.confirm('确认要批量删除吗？',function(index){
		...
		$.ajax({
			type: 'POST',
			url: "<?php
echo parse_url_tag("u:admin|help#fenlei_dels|"."".""); 
?>",
			dataType: 'json',
			data:{
				'ids':checked
...
/*用户-编辑*/
function fenlei_edit(title,url,id,w,h){
	var u = url+'&id='+id;
	layer_show(title,u,w,h);
}

/*管理员-删除*/
function fenlei_del(obj,id){
	pro={};
	pro.id=id;
	layer.confirm('确认要删除吗？',function(index){
		$.ajax({
			type: 'POST',
			url: '<?php
echo parse_url_tag("u:admin|help#fenlei_del|"."".""); 
?>',
			dataType: 'json',
			data:pro,
			success: function(data){
