...
<script>
	...
	var url = '<?php
echo parse_url_tag("u:admin|licai#regular_update|"."".""); 
?>';
	var server_url = '<?php
echo parse_url_tag("u:admin|licai#regular_update|"."".""); 
?>';
	var uploadImg  = '<?php
echo parse_url_tag("u:admin|licai#upload_img|"."".""); 
?>';
...
<div class="page-container">
	<form action="" method="post" onsubmit="return false;" class="form form-horizontal" id="form-article-edit" autocomplete="off">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-1 col-sm-3">
				<input name="end_buy_date" type="date" value="<?php echo $this->_var['data']['end_buy_date']; ?>"/>
			</div>
			<div class="formControls col-xs-7 col-sm-7">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-1 col-sm-3">
				<input type="text" class="input-text" value="<?php echo $this->_var['data']['time_limit']; ?>" placeholder="" id="time_limit" name="time_limit">
			</div>
			<div class="formControls col-xs-7 col-sm-7">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9"> 
				<script id="editor" name="description" type="text/plain" style="width:100%;height:400px;" value=""></script> 
			</div>
		</div>
		 <div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">赎回到账时间描述：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<textarea id="purchasing_time" name="purchasing_time" value="" cols="" rows="" class="textarea"  placeholder="说点什么...最少输入10个字符" datatype="*10-100" dragonfly="true" nullmsg="备注不能为空！" onKeyUp="$.Huitextarealength(this,200)"><?php echo $this->_var['data']['purchasing_time']; ?></textarea>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<!-- <textarea id="rule_info" name="rule_info" value="" cols="" rows="" class="textarea"  placeholder="说点什么...最少输入10个字符" datatype="*10-100" dragonfly="true" nullmsg="备注不能为空！" onKeyUp="$.Huitextarealength(this,200)"><?php echo $this->_var['data']['rule_info']; ?></textarea> -->
...
<script type="text/javascript">console.log(uploadImg);</script>
