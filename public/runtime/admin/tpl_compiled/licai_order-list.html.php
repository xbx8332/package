...
<body >
	<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 产品管理 <span class="c-gray en">&gt;</span> 活期宝 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
...
?>
				<tbody>
					<tr class="text-c va-m">
						...
						<td><?php echo $this->_var['list']['interest_rate']; ?></td>
						<td><?php echo $this->_var['list']['create_date']; ?></td>
						<td><?php echo $this->_var['list']['end_interest_date']; ?></td>
						<td><?php if ($this->_var['list']['begin_interest_type'] == 0): ?>当日生效<?php elseif ($this->_var['list']['begin_interest_type'] == 1): ?>次日生效<?php elseif ($this->_var['list']['begin_interest_type'] == 2): ?>下个工作日生效<?php endif; ?></td>
