...
<div class="page-container">
	<form class="form form-horizontal" id="form-picture-add">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				...
				<select name="" class="select">
					...
					<option value="1">顶部轮播</option>
					<option value="2">底部图片</option>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="date"  id="datemin" class="input-text Wdate">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>结束日期：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="date"  id="datemax" class="input-text Wdate">
			</div>
		</div> -->
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-3 col-sm-3">
				<input type="file"  id="img0" name="img[]" placeholder="" value="" class="input-text" onchange="showPreview(this)">
			</div>
			<div class="formControls col-xs-5 col-sm-7">
				
				<img id="portrait_0" src="<?php if ($this->_var['data']['img']): ?><?php echo $this->_var['data']['img']; ?><?php endif; ?>"    width="150" height="100"> 
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">
				...
				首页轮播图2：</label>
			<div class="formControls col-xs-3 col-sm-3">
				<input type="file" id="img1" name="img[]" placeholder="" value="" class="input-text" onchange="showPreview1(this)">
			</div>
			<div class="formControls col-xs-5 col-sm-7">
				
				<img id="portrait_1" src="<?php if ($this->_var['data']['img']): ?><?php echo $this->_var['data']['img']; ?><?php endif; ?>"   width="150" height="100"> 
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">
				...
				首页底部图片：</label>
			<div class="formControls col-xs-3 col-sm-3">
				<input type="file" id="img2" name="img[]" placeholder="" value="" class="input-text" onchange="showPreview2(this)">
			</div>
			<div class="formControls col-xs-5 col-sm-7">
				
				<img id="portrait_2" src=""   width="150" height="100"> 
			</div>
		</div>
		<!-- <div class="row cl">
	...
	$("#form-picture-add").validate({
		...
		submitHandler:function(form){
			...
			$(form).ajaxSubmit({
				...
				dataType:'json',
				url:"<?php
echo parse_url_tag("u:admin|system#picture_insert|"."".""); 
?>",
				data:$(form).serialize(),
	...
	var uploader = WebUploader.create({
		auto: true,
		swf: '/Admin/Tpl/public/lib/webuploader/0.1.5/Uploader.swf',
	
		// 文件接收服务端。
		server: '/Admin/Tpl/public/lib/webuploader/0.1.5/server/fileupload.php',
...
function showPreview(source) {  
    ...
    if (window.FileReader) {  
        ...
        fr.onloadend = function(e) {  
            document.getElementById("portrait_0").src = e.target.result;  
        };  
...
function showPreview1(source) {  
    ...
    if (window.FileReader) {  
        var fr = new FileReader();  
        fr.onloadend = function(e) {  
            document.getElementById("portrait_1").src = e.target.result;  
        };  
        fr.readAsDataURL(file);  
    }  
}
function showPreview2(source) {  
    ...
    if (window.FileReader) {  
        var fr = new FileReader();  
        fr.onloadend = function(e) {  
            document.getElementById("portrait_2").src = e.target.result;  
        };  
        fr.readAsDataURL(file);  
    }  
}
