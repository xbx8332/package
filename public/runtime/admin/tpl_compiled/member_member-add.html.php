	...
	<form action="" method="post" class="form form-horizontal" id="form-member-add">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="" autocompelete="off" placeholder="" id="user_name" name="user_name">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>密码：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="password" class="input-text" value="" autocompelete="off" placeholder="" id="user_pwd" name="user_pwd">
			</div>
		</div>
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9 skin-minimal">
				...
				<div class="radio-box">
					<input type="radio" id="sex-3" name="sex"  value="-1">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text"  name="bankcard"  value="">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>开户行：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text"  name="bankname"  value="">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>支付密码：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input class="input-text"  name="paypassword" type="password" value="">
			</div>
		</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<textarea name="content" cols="" rows="" class="textarea"  placeholder="说点什么...最少输入10个字符"  value=""></textarea>
	...
	$("#form-member-add").validate({
		...
		submitHandler:function(form){
			...
			$.ajax({
				type:'POST',
				url:"<?php
echo parse_url_tag("u:admin|member#member_insert|"."".""); 
?>",
				data:$(form).serialize(),
				success:function(res)
				{
					var rev = JSON.parse(res);
					if(rev.returnCode == 1){
						layer.msg(rev.returnMsg,{icon:1,time:1000},function(){parent.location.reload();});
					}else{
						layer.msg(rev.returnMsg,{icon:1,time:1000});
					}
					/* var res = Boolean(res);
					if(res)
