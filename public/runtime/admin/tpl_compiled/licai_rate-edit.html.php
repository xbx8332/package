...
<article class="page-container">
	<form action="<?php
echo parse_url_tag("u:admin|licai#rateinsert|"."".""); 
?>" method="post" class="form form-horizontal" id="form-rate-edit">
		
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><!-- <span class="c-red">*</span> -->日期：</label>
			<div class="formControls col-xs-1 col-sm-2">
				<input id="dat" name = "history_date" type="date" />
			</div>
		...
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>利率：</label>
			<div class="formControls col-xs-5 col-sm-5">
				<input type="text" class="input-text" value="" placeholder="" id="rate_value" name="rate">
			</div>
		...
		<!-- <div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>万分收益：</label>
			<div class="formControls col-xs-5 col-sm-5">
		...
		<div class="row cl">
			<div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-3">
				<input type="text" class="input-text" value="<?php echo $this->_var['data']['id']; ?>" hidden placeholder="" id="licai_id" name="licai_id">
