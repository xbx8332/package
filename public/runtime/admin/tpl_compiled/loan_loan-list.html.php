...
?>
					<tr class="text-c va-m">
						...
						<td><?php echo $this->_var['list']['mobile']; ?></td>
						<td><?php echo $this->_var['list']['loanmoney']; ?></td>
						<td><?php if ($this->_var['list']['term'] == 0): ?>无<?php else: ?>有<?php endif; ?></td>
						<td><?php echo $this->_var['list']['type']; ?></td>
						<td><?php echo $this->_var['list']['mortgage']; ?>个月</td>
						<td><?php if ($this->_var['list']['cycle'] == 'm'): ?> 按月还款 <?php elseif ($this->_var['list']['cycle'] == 'y'): ?>按年还款<?php else: ?>按季还款<?php endif; ?></td>
						<td class="td-status"><?php if ($this->_var['list']['start'] == 0): ?><span class="label label-warning radius">未审核</span><?php elseif ($this->_var['list']['start'] == 1): ?><span class="label label-success radius">已放款</span><?php else: ?><span class="label label-defaunt radius">已拒绝</span><?php endif; ?></td>
						<td class="td-manage">
						<?php if ($this->_var['list']['start'] == 0): ?>
						<a style="text-decoration:none"class="ml-5" onClick="loan_start(this,<?php echo $this->_var['list']['id']; ?>)" href="javascript:;" title="同意"><i class="Hui-iconfont">&#xe6e1;</i></a>
						<a style="text-decoration:none" class="ml-5"  onClick="loan_stop(this,<?php echo $this->_var['list']['id']; ?>)" href="javascript:;" title="拒绝"><i class="Hui-iconfont">&#xe6dd;</i></a>
						<?php endif; ?>
						<a style="text-decoration:none" class="ml-5" onClick="loan_del(this,<?php echo $this->_var['list']['id']; ?>)" href="javascript:;" title="删除"><i class="Hui-iconfont">&#xe6e2;</i></a>
						</td>
					</tr>
...
function loan_stop(obj,id){
	layer.confirm('确认要拒绝吗？',function(index){
		...
		$.ajax({
			type: 'POST',
			url: "<?php
echo parse_url_tag("u:admin|loanmanage#loanstop|"."".""); 
?>",
			dataType: 'json',
			data:pro,
...
function loan_start(obj,id){
	layer.confirm('确认要同意吗？',function(index){
		...
		$.ajax({
			type: 'POST',
			url: "<?php
echo parse_url_tag("u:admin|loanmanage#loanstart|"."".""); 
?>",
			dataType: 'json',
			data:pro,
			success: function(data){
...
function loan_del(obj,id){
	layer.confirm('确认要删除吗？',function(index){
		...
		$.ajax({
			type: 'POST',
			url: "<?php
echo parse_url_tag("u:admin|loanmanage#loandel|"."".""); 
?>",
			dataType: 'json',
			data:pro,
			success: function(data){
