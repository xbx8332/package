...
<script>
	var url = '<?php
echo parse_url_tag("u:admin|licai#issueMoney_update|"."".""); 
?>';
</script>
</head>
<body>
<div class="page-container">
	<form action="" method="post" onsubmit="return false;" class="form form-horizontal" id="form-article-edit">
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>类型名称：</label>
			<div class="formControls col-xs-1 col-sm-3">
			<input type="text" class="input-text" value="<?php if ($this->_var['data']['id']): ?><?php echo $this->_var['data']['id']; ?><?php endif; ?>" hidden placeholder="" id="id" name="id">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-1 col-sm-3">
				<input type="text" class="input-text" value="<?php if ($this->_var['data']['money']): ?><?php echo $this->_var['data']['money']; ?><?php endif; ?>" placeholder="" id="money" name="money">
			</div>
			<div class="formControls col-xs-7 col-sm-7">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-1 col-sm-3">
				<input type="text" class="input-text" value="<?php if ($this->_var['data']['time_limit']): ?><?php echo $this->_var['data']['time_limit']; ?><?php endif; ?>" placeholder="" id="time_limit" name="time_limit">
			</div>
			<div class="formControls col-xs-7 col-sm-7">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-1 col-sm-3">
				<input type="text" class="input-text" value="<?php if ($this->_var['data']['max_money']): ?><?php echo $this->_var['data']['max_money']; ?><?php endif; ?>" placeholder="" id="max_money" name="max_money">
			</div>
			<div class="formControls col-xs-7 col-sm-7">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-1 col-sm-3">
				<input name = "begin_time" type="date" value="<?php if ($this->_var['data']['begin_time']): ?><?php echo $this->_var['data']['begin_time']; ?><?php endif; ?>" />
			</div>
			<div class="formControls col-xs-7 col-sm-7">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-1 col-sm-3">
				<input name="end_time" type="date" value="<?php if ($this->_var['data']['end_time']): ?><?php echo $this->_var['data']['end_time']; ?><?php endif; ?>" />
			</div>
			<div class="formControls col-xs-7 col-sm-7">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-2 col-sm-2"> 
				...
				<select class="select" id="type" name="type" >
					<option value="0" <?php if ($this->_var['data']['type'] == 0): ?>selected<?php endif; ?>>注册送</option>
					<option value="1" <?php if ($this->_var['data']['type'] == 1): ?>selected<?php endif; ?>>邀请送</option>
					<option value="2" <?php if ($this->_var['data']['type'] == 2): ?>selected<?php endif; ?>>管理员发放</option>
				</select>
				</span> 
			</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-2 col-sm-2"> 
				...
				<select class="select" id="is_effect" name="is_effect" >
					...
					<option value="0" <?php if ($this->_var['data']['is_effect'] == '0'): ?>selected<?php endif; ?>>否</option>
					
					<option value="1" <?php if ($this->_var['data']['is_effect'] == '1'): ?> selected<?php endif; ?>>是</option>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<textarea id="brief" name="brief" cols="" rows="" class="textarea"  placeholder="说点什么...最少输入10个字符" datatype="*10-100" dragonfly="true" nullmsg="备注不能为空！" onKeyUp="$.Huitextarealength(this,200)"><?php if ($this->_var['data']['brief']): ?><?php echo $this->_var['data']['brief']; ?><?php endif; ?></textarea>
